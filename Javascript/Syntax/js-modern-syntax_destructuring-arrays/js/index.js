...
const unnestedStudents = [nestedStudents[0], ...nestedStudents[1], ... nestedStudents[2]];

export const = [student1, student2, student3,student4,student5, student6]= unnestedStudents;
