...
const onlyTitles = recipes.map((recepie) => recepie.title);

//console.log(onlyTitles);
// ['Crepes', ...]

const titlesWithDuration = recipes.map(
  (recepie) => recepie.title && recepie.duration
);
...
const allTitlesInOneString = recipes.map((recepie) => recepie.title).join("");
